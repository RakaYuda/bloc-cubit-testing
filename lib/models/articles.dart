...
class Articles {
  ...
  @override
  String toString() {
    return 'Articles{articles: $listArticle}';
  }
}
...
class Article {
  ...
  @override
  String toString() {
    return 'Article{id : $id , img_article : $imgArticle ,title_article: $titleArticle, article :$article ,post_date :$postDate ,published :$published ,id_author :$idAuthor , author : $author}';
  }
